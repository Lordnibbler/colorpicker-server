...
<div class="color">\
  ...
  <div class="meta-controls">\
    <button class="meta-details btn btn-sunken"><i class="fa fa-cog fa fa-lg"></i></button>\
    <button class="destroy btn"><i class="fa fa-times fa fa-lg"></i></button>\
  </div>\
</div>\
<div class="details">\
  <div class="color-input rgb">\
    rgb(<span class="number-widget r">\
      ...
      <button class="stepper up btn"><i class="fa fa-caret-up"></i></button>\
      <button class="stepper down btn"><i class="fa fa-caret-down"></i></button>\
